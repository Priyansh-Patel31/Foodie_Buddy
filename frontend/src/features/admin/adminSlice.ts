...
const FALLBACK_MENU: MenuItem[] = [
  ...
  { id: 'm3', name: 'Garlic Bread', price: 150, category: 'Breads', categoryName: 'Breads', description: 'Roasted garlic butter bread sticks.', imageUrl: 'https://i1.wp.com/thetwincookingproject.net/wp-content/uploads/2020/05/Homemade-Dominos-Garlic-Bread_-scaled.jpg?fit=1707%2C2560&ssl=1', isAvailable: true, isVegetarian: true, toppings: [] },
