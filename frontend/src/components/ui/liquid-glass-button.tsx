...
const colorVariants: Record<ColorVariant, { outer: string; inner: string; button: string; textColor: string; textShadow: string; }> = {
  default: {
    outer: "bg-gradient-to-b from-[#D4D4D4] to-[#737373]",
    inner: "bg-gradient-to-b from-[#FFFFFF] via-[#E5E5E5] to-[#D4D4D4]",
    button: "bg-gradient-to-b from-[#FFFFFF] to-[#E5E5E5]",
    textColor: "text-gray-800",
    textShadow: "[text-shadow:_0_1px_0_rgb(255_255_255_/_100%)]",
  },
  primary: {
    outer: "bg-gradient-to-b from-[#C2410C] to-[#7C2D12]",
    inner: "bg-gradient-to-b from-[#FFEDD5] via-[#EA580C] to-[#9A3412]",
    button: "bg-gradient-to-b from-[#F97316] to-[#C2410C]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(154_52_18_/_100%)]",
  },
  success: {
  ...
  error: {
    outer: "bg-gradient-to-b from-[#7F1D1D] to-[#FCA5A5]",
    inner: "bg-gradient-to-b from-[#FEF2F2] via-[#B91C1C] to-[#EF4444]",
    button: "bg-gradient-to-b from-[#F87171] to-[#DC2626]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(153_27_27_/_100%)]",
  },
  gold: {
...
export const metalButtonVariants = (variant: ColorVariant = "default", isPressed: boolean, isHovered: boolean, isTouchDevice: boolean) => {
